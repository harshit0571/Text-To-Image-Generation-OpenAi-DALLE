  ...
  return (
    <div className="rounded-xl group relative shadow-card hover:shadow-cardhover">
      <img
        ...
        alt={prompt}
      />
      <div className="group-hover:flex flex-col max-h-[94.6%] hidden absolute bottom-0 left-0 right-0 bg-[#10131f] m-2 p-4 rounded-md">
        ...
        <div className="mt-5 flex justify-between items-center gap-2">
          ...
          <button
            ...
            className="outline-none bg-transparent object-contain"
          >
